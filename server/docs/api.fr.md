...
Avant ces commandes d’installation, préparez les répertoires hôtes et exportez UID/GID selon la [configuration initiale du guide utilisateur](user-guide.fr.md).
